...
{
    public partial class ProductController : Controllers.Abstract
    {
        public ProductController(Services.Data.Core.IUnitOfWork unitOfWork) : base(unitOfWork) {}
        ...
        public IActionResult Index()
        {
            try
            {
                ...
                _unitOfWork.FormationRepository.Get(products);
        ...
        public IActionResult Detail (int? id)
        {
            ...
            {
                _unitOfWork.FormationRepository.Get(product);
        ...
        public IActionResult Edit(Models.Product model)
        {
            ...
            {
                _unitOfWork.FormationRepository.Get(model.GetCore());
                model.Backet = new Models.FormationVal(model.GetCore().Formation);
