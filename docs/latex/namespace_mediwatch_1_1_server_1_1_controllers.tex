...
\item 
class \mbox{\hyperlink{class_mediwatch_1_1_server_1_1_controllers_1_1_checkout_controller}{Checkout\+Controller}}
\item 
...
Fichier avec les fonctions relatif aux controleurs des User\+Info. Cela permet d\textquotesingle{}avoir les information publique

Fichier avec les fonctions relatif aux controleurs des Tag.

Fichier avec les fonctions relatif aux controleurs des Join\+Tag. Les Join\+Tag font la liaison entre les Formation et les Tag

Fichier avec les fonctions relatif aux controleurs des Formation.

Fichier avec les fonctions relatif aux controleurs des Applicant\+Session. A chaque inscription à une formation l\textquotesingle{}utilisateur créer un Applicant\+Session